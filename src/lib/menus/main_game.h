...
const int MG_count_menu_icons = 8; // length of the two arrays below (they must match!)

#pragma PERSISTENT(MG_menu_icons)
const char MG_menu_icons[8] = {
                               ...
                               0x18, // Toothbrush Icon - Flush the screen
                               0x0B // Beetle Icon - Maps to the Debug Menu
};

extern voidFuncPointer MG_menu_options_array[8];
